...
const propertyList = () => {
  return (
    <div className="pList">
        ...
        <div className="pListItems">
            <img src="//cf.bstatic.com/static/img/theme-index/carousel_320x240/card-image-villas_300/dd0d7f8202676306a661aa4f0cf1ffab31286211.jpg" alt="" className="pListImg"/>
        <div className="pListTitles">
            <h1>Cabins</h1>
            <h2>1303 hotels</h2>
        </div>
